...
class MainMenu(tk.Menu):
    ...
    def __init__(self, parent, callbacks, recent_files, dark_mode, **kwargs):
        ...
        self.project_menu.add_separator()
        self.project_menu.add_command(label='Refresh Sect/Inst Positions', command=callbacks['prj->refresh_pos'])
    ...
    def disable_script_commands(self):
        ...
        self.project_menu.entryconfig('Refresh Sect/Inst Positions', state='disabled')
